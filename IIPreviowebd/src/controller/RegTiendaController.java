...
/**
 * Servlet implementation class RegTiendaController
 */
@WebServlet("/RegTiendaController")
public class RegTiendaController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public RegTiendaController() {
        super();
